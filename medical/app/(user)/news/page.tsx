    ...
    <div className="relative">
      <Banner>
        ...
        <div className="relative flex flex-col justify-center h-full z-20 px-4">
          <h4 className="text-primary-blue text-lg font-normal font-work-sans">Home / News</h4>
          <h2 className="text-primary-blue text-5xl font-bold font-yeseva">Blog Posts</h2>
        </div>
      </Banner>
    </div>
      <Bannerpartition/>
